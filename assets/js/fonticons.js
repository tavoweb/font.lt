(function() {
	...
	var createControl = function(name, controlManager) {
		if (name != 'fonticonsGlyphSelect') return null;
		var listBox = controlManager.createListBox('fonticonsGlyphSelect', {
			title: 'Glyphs',
			onselect: function(v) {
	...
	tinymce.create('tinymce.plugins.FonticonsGlyphPlugin', {
		createControl: createControl
	});

	tinymce.PluginManager.add('fonticons_glyphs', tinymce.plugins.FonticonsGlyphPlugin);
